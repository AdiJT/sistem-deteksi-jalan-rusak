...
public static class DistressDensityToDV
{
    ...
    public static double RetakBuaya(double density, DamageType type)
    {
        ...
        return type switch
        {
            DamageType.Low => CubicSpline.InterpolatePchipSorted(_x, yL).Interpolate(density),
            DamageType.Medium => CubicSpline.InterpolatePchipSorted(_x, yM).Interpolate(density),
            DamageType.High => CubicSpline.InterpolatePchipSorted(_x, yH).Interpolate(density),
            _ => throw new ArgumentException(null, nameof(type)),
        };
    }

    public static double Bleeding(double density, DamageType type)
    {
    ...
    public static double Alur(double density, DamageType type)
    {
    ...
    public static double Lubang(double density, DamageType type)
    {
    ...
    public static double PelepasanButir(double density, DamageType type)
    {
    ...
    public static double RetakMemanjang(double density, DamageType type)
    {
        ...
        return type switch
        {
            DamageType.Low => CubicSpline.InterpolatePchipSorted(x, yL).Interpolate(density),
            DamageType.Medium => CubicSpline.InterpolatePchipSorted(x, yM).Interpolate(density),
            DamageType.High => CubicSpline.InterpolatePchipSorted(x, yH).Interpolate(density),
            _ => throw new ArgumentException(null, nameof(type)),
        };
    }

    public static double Tambalan(double density, DamageType type)
    {
